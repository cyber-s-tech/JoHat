...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1C1C1C] text-white w-full relative overflow-hidden">
      ...
      {/* Background Text */}
      <h1 className="relative bottom-[20px] left-0 w-full text-center font-designer font-normal text-white/10 leading-none select-none pointer-events-none text-[25px] md:text-[40px] lg:text-[65px] xl:text-[95px]">
